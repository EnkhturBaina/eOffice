import { Button, Divider, Input, Form, DatePicker, Upload } from "antd";
...
function WorkContractUpdate(props) {
  ...
  const strDataFnc = () => {
    props.contractData.startDate = dayjs(
      props.contractData.startDate,
      dateFormat
    );
    props.contractData.endDate = dayjs(props.contractData.endDate, dateFormat);
    form.setFieldsValue(props.contractData);
  };
    ...
    <div>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-x-4">
          ...
          <Form.Item
            name={"startDate"}
            label={<span className="text-xs text-slate-500">Эхлэх огноо</span>}
            className="custom-form-item"
          >
            <DatePicker
              onChange={onChange}
          ...
          <Form.Item
            name={"endDate"}
            label={<span className="text-xs text-slate-500">Дуусах огноо</span>}
            className="custom-form-item"
          >
            <DatePicker
              onChange={onChange}
...
export default WorkContractUpdate;
