...
const Attendance_LIST = React.lazy(() =>
  import("./views/Attendance/attendance")
);
const Attendance_REQUEST = React.lazy(() =>
  import("./views/Attendance/request")
);
const Main_Report = React.lazy(() => import("./views/Report"));

const routes = [
  { path: "/", exact: true, name: "Home" },
  { path: "/hrm", name: "Employee", element: Employee },
